...
public class DatahubTariffFilterFactory {
    ...
    public static final LocalDate KONSTANT_CUTOFF_DATE = LocalDate.of(2023, 1, 1);
    ...
    public static DatahubTariffFilter getNetTariffByGLN(String globalLocationNumber) {
        switch (globalLocationNumber) {
            ...
            case GLN_KONSTANT:
                return new DatahubTariffFilter(Set.of(ChargeTypeCode.of("151-NT01T")), Set.of(NOTE_NET_TARIFF_C_HOUR),
                        DateQueryParameter.of(KONSTANT_CUTOFF_DATE));
            case GLN_L_NET:
